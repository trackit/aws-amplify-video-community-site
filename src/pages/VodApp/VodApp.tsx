...
const VodApp = () => {
    ...
    useEffect(() => {
        ...
        const getHighlightedVideos = API.graphql(graphqlOperation(listVodAssets, {filter})) as Promise<GraphQLResult>
        getHighlightedVideos
            .then((data) => {
                console.log("highlightedVideos", data)
            })

        const sectionsQuery = API.graphql(graphqlOperation(listSections, {nextToken: ''})) as Promise<GraphQLResult>
