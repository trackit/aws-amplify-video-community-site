...
function GetFiles({func: setVodAssets}: any) {
    ...
    return (
        <button onClick={() => {
            const getFilesQuery = listVodFiles(nextToken) as Promise<GraphQLResult>
                getFilesQuery
                .then((data: any) => {
                    console.log(data)
    ...
    return (
        <form onSubmit={uploadVod}>
            ...
            <div>
                ...
                <input id="highlighted" type='checkbox' onChange={() => {
...
const CreateSection = () => {
    ...
    return (
        <form onSubmit={createNewSection}>
            ...
            <input id='new-section' type='text' onChange={(e) => setNewSection(e.target.value)}/>
